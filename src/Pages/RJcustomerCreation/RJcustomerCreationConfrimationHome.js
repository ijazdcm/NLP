...
const RJcustomerCreationConfrimationHome = () => {
      ...
      Action: (
        <CButton className="badge text-white" color="warning">
          <Link
            ...
            to="RJcustomerCreationConfrimationHome/RJcustomerCreationConfrimation"
          >
            RJ Customer Confrim
          </Link>
        </CButton>
...
export default RJcustomerCreationConfrimationHome
