...
const TripSheetSettleMentFG = () => {
  ...
  return (
    <CCard>
      <CNav variant="tabs" size="sm" role="tablist" className="m-1">
        <CNavItem>
          <CNavLink
          ...
          <CForm className="p-2" onSubmit={handleSubmit}>
            ...
            <CRow className="">
              ...
              <CCol xs={12} md={3}>
                ...
                <CFormInput onClick size="sm" id="inputAddress"  readOnly />
              </CCol>
              <CCol xs={12} md={3}>
                <CFormLabel htmlFor="inputAddress">
                  Closing Odometer KM
                ...
                <CFormInput
                  onClick={() => setClosingOdometerPhoto(!ClosingOdometerPhoto)}
                  size="sm"
                  id="inputAddress"
                  value="view"
                  readOnly
                />
                <CModal
                  visible={ClosingOdometerPhoto}
                  onClose={() => setClosingOdometerPhoto(false)}
                >
                  <CModalHeader>
                  ...
                  <CModalFooter>
                    <CButton color="secondary" onClick={() => setClosingOdometerPhoto(false)}>
                      Close
                    </CButton>
                    <CButton color="primary">Save changes</CButton>
                  </CModalFooter>
      ...
      <CTabContent>
        <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey === 2}>
          <CNav variant="tabs" size="sm" className="m-2" role="tablist">
            <CNavItem>
              <CNavLink
                className="btn btn-sm"
                href="javascript:void(0);"
                active={activeKeySub === 1}
                onClick={() => setactiveKeySub(1)}
              >
                Summary
              </CNavLink>
            </CNavItem>
            <CNavItem>
              <CNavLink
                className="btn btn-sm"
                href="javascript:void(0);"
                active={activeKeySub === 2}
                onClick={() => setactiveKeySub(2)}
              >
                Shipment 1
              </CNavLink>
            </CNavItem>
          ...
          <CTabContent>
            <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKeySub === 1}>
              <CContainer>
                <CRow>
                  <CCol xs={12} md={8} className="p-3">
                    <CTable>
                      ...
                      <CTableBody>
                        ...
                        <CTableRow>
                          <CTableHeaderCell scope="row">Shipment 2</CTableHeaderCell>
                          <CTableDataCell>27000</CTableDataCell>
                          <CTableDataCell>1500</CTableDataCell>
                          <CTableDataCell>25500</CTableDataCell>
                        </CTableRow>
                        <CTableRow>
                          <CTableHeaderCell scope="row">Shipment 3</CTableHeaderCell>
                          <CTableDataCell>27000</CTableDataCell>
                          <CTableDataCell>1500</CTableDataCell>
                          <CTableDataCell>25500</CTableDataCell>
                        </CTableRow>
                        <CTableRow>
                          ...
                          <CTableDataCell>15500</CTableDataCell>
                          <CTableDataCell>38500</CTableDataCell>
                        </CTableRow>
                      </CTableBody>
                    </CTable>
                  </CCol>
          ...
          <CRow>
            <CCol className="mt-3 py-2" xs={12} sm={12} md={3}>
              <CButton size="sm" color="primary" className="mx-3 text-white" type="button">
...
export default TripSheetSettleMentFG
